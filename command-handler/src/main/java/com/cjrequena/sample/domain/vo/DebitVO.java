...
import com.cjrequena.sample.exception.service.AccountIdException;
...
public record DebitVO(
  ...
  public DebitVO {
    ...
    if (accountId == null) {
      throw new AccountIdException("AccountId is required");
    }
    ...
    if (amount == null) {
      ...
      if (amount.compareTo(BigDecimal.ZERO) <= 0) {
        throw new AmountServiceException("Debit amount must be positive");
      }
    }
  }
