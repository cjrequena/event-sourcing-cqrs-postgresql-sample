...
@Slf4j
@RestController
@RequestMapping(value = AccountQueryController.ENDPOINT, headers = {AccountQueryController.ACCEPT_VERSION})
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
public class AccountQueryController {

  public static final String ENDPOINT = "/api/query-handler";
  ...
  public ResponseEntity<AccountDTO> retrieveById(@PathVariable("accountId") UUID accountId) throws NotFoundException {
    try {
